...
SH.AvatarViewItem = Class.extend({
    ...
    setSkypename: function(c) {
        ...
        this.$actions.find("a.call").attr("href", "skymu:" + c + "?call");
        this.$actions.find("a.message").attr("href", "skymu:" + c + "?chat")
    },
    getSkypename: function() {
...
SH.AvatarView = function() {
    ...
    return {
        ...
        addDefaultContact: function() {
            ...
            var k = j + '<div class="avatarItem default ' + l + '">					<a href="skymu:?importcontacts" class="addContact ' + SH.Translator.createClassName("avatarView", "add", "title") + '" title="' + SH.Translator.translate("avatarView", "add", "title") + '" sh_tracking="avatarView_addContact">' + SH.Translator.translate("avatarView", "add") + "</a>				</div>";
            h.append(k);
...
SH.MyselfPanel = function() {
    ...
    var e;
    var c = 300;
    var j = '<div class="header clearfix">		<h1>' + SH.Translator.translate("myselfPanel", "header") + '</h1>		<div class="rightNavControls clearfix">			<a href="#showAvatarView" class="buttonSmall ' + (SH.AvatarView.getSavedStateStatus() ? "selected" : "") + " showAvatarView " + SH.Translator.createClassName("myselfPanel", "showTopContacts", "title") + '" title="' + SH.Translator.translate("myselfPanel", "showTopContacts", "title") + '" sh_tracking="myselfPanel_avatarViewToggle">				<span class="innerButton" >' + SH.Translator.translate("myselfPanel", "showTopContacts") + '</span>			</a>			<a href="#settings" class="settings ' + SH.Translator.createClassName("feedSettings", "headerTitle", "title") + '" title="' + SH.Translator.translate("feedSettings", "headerTitle", "title") + '" sh_tracking="myselfPanel_feedSettingsToggle"></a>		</div>	</div>	<div class="body clearfix">		<a class="avatar ' + SH.Translator.createClassName("myselfPanel", "changePicture", "title") + '" href="skymu:?mypictures" title="' + SH.Translator.translate("myselfPanel", "changePicture", "title") + '" sh_tracking="myselfPanel_changeAvatarPhoto">			<img class="user' + SH.API.localUser.getSkypename() + '" src="httpfe://avatar.local/' + SH.API.localUser.getSkypename() + '"/>		</a>		<div class="textareaContainer">			<div class="bubbles"></div>			<div class="topBorder">				<div class="bottomBorder">						<textarea id="myMoodMessage"></textarea>				</div>			</div>			<div class="editControls clearfix">				<div class="movie">					<a href="skymu:?multimedia_mood" class="control ' + SH.Translator.createClassName("myselfPanel", "addVideo", "title") + '" title="' + SH.Translator.translate("myselfPanel", "addVideo", "title") + '"" sh_tracking="myselfPanel_addDragonflyMedia"></a>				</div>				<div class="share clearfix">					<a href="#update" class="buttonSmall control ' + SH.Translator.createClassName("myselfPanel", "share", "title") + '" title="' + SH.Translator.translate("myselfPanel", "share", "title") + '" sh_tracking="myselfPanel_updateMoodMessage">						<span class="innerButton" >' + SH.Translator.translate("myselfPanel", "share") + "</span>					</a>				</div>			</div>		</div>	</div>";
    var i = false;
    var k = false;
    var g = null;
    return {
...
SH.VideoRoster = function() {
    ...
    var d = "<h2>" + SH.Translator.translate("videoroster", "videosHeading") + '</h2>		<div class="videoContainer">			<div id="videoRosterFlashObject">				<div class="noFlash">' + SH.Translator.translate("videoroster", "noFlashPlayer") + '<br/>					<a id="promoLink_<tid>1" href="skymu:?getflash">' + SH.Translator.translate("videoroster", "downloadFlash") + '</a>				</div>			</div>		</div>		<div id="videosIndex" class="nodesIndex"></div>		<h2>' + SH.Translator.translate("videoroster", "wizardsHeading") + '</h2>		<ul class="linksRow clearfix first">			<li class="makeCall">				<a href="skymu:?addcontact" class="icon" sh_tracking="videoRoster_addContactWizard"><img src="i/images/promos/promo_find_people_you_know.png"/></a>				<div class="group clearfix">					<p class="text"><strong class="heading">' + SH.Translator.translate("videoroster", "findFriends") + "</strong>" + SH.Translator.translate("videoroster", "searchFrom") + '</p>					<a href="skymu:?addcontact" class="button" sh_tracking="videoRoster_addContactWizard"><span class="innerButton">' + SH.Translator.translate("videoroster", "start") + '</span></a>				</div>			</li>			<li class="findFriends last">				<a href="skymu:?cqg" class="icon" sh_tracking="videoRoster_callQualityWizard"><img src="i/images/promos/audio_quality_60x65.png"/></a>				<div class="group clearfix">					<p class="text"><strong class="heading">' + SH.Translator.translate("videoroster", "improveCallQuality") + "</strong>" + SH.Translator.translate("videoroster", "makeCallQualityBetter") + '</p>					<a href="skymu:?cqg" class="button" sh_tracking="videoRoster_callQualityWizard"><span class="innerButton">' + SH.Translator.translate("videoroster", "start") + '</span></a>				</div>			</li>		</ul>		<ul class="linksRow separator clearfix last">			<li class="makeCall">				<a href="skymu:?gettingstarted#devices" class="icon" sh_tracking="videoRoster_devicesWizard"><img src="i/images/promos/hardware_test_70x57.png"/></a>				<div class="group clearfix">					<p class="text"><strong class="heading">' + SH.Translator.translate("videoroster", "setUpSoundEquipment") + "</strong>" + SH.Translator.translate("videoroster", "makeSureEverythingsAlright") + '</p>					<a href="skymu:?gettingstarted#devices" class="button" sh_tracking="videoRoster_devicesWizard"><span class="innerButton">' + SH.Translator.translate("videoroster", "start") + "</span></a>				</div>			</li>		</ul>";
...
SH.Feed = function() {
    ...
    var e = '<div class="item defaultMessage">		<div class="normalContent">			' + SH.Translator.translate("feedItem", "noUpdatesYet") + '. 			<span class="moreInfo">				<a href="skymu:?addcontact" sh_tracking="noContactsMessage_addContact">' + SH.Translator.translate("feedItem", "findFriends") + "</a> 				" + SH.Translator.translate("feedItem", "or") + ' 				<a href="skymu:?importcontacts" sh_tracking="noContactsMessage_importContacts">' + SH.Translator.translate("feedItem", "importContacts") + "</a> 			</span>		</div>	</div>";
    var h;
    return {
        memoryCleanup: function() {
            a = null;
