...
* [Download Visual Studio 2019](https://aka.ms/vs/16/release/vs_community.exe) or [Visual Studio 2026](https://aka.ms/vs/18/Stable/vs_community.exe). Select ".NET desktop development" in the installer.
