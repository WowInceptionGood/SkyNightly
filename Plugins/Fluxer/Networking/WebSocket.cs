...
// This was made with the help of the documentation from fluxer.sex
...
namespace Fluxer.Networking
{
    class WebSocket
    {
        ...
        // Fluxer's WebSocket / Gateway URL
        private string gatewayUrl;

        // The Fluxer token used by the user
        ...
        // The interval Fluxer sends back to us from WebSocket
        ...
        public event EventHandler<HelperClasses.FluxerMessageReceivedEventArgs> MessageReceived;
        ...
        private readonly Channel<HelperClasses.FluxerMessageReceivedEventArgs> _messageQueue =
    Channel.CreateUnbounded<HelperClasses.FluxerMessageReceivedEventArgs>(
        ...
        public WebSocket(string token, Core core)
        {
            ...
            gatewayUrl = "wss://gateway.fluxer.gg/?encoding=json&v=9&compress=zlib-stream"; // omega add compression
