...
// omega: some of this is probably re-usable for LiveKit, so
// I'm keeping the file in with DAVE references commented out
// if I'm wrong, we can remove it later, ideally replace it
// with some sort of abstracted LiveKit SDK
